...
route.post('/cadastro-prestador', urlencodedParser, async (req,res) => {
...
route.post('/cadastroPrefilUsuario', urlencodedParser, verificarAutenticacao, async (req, res) => {
    try {
        const { 
        ...
        await PerfilUsuario.create({
            ...
            numero,
            complemento
            // foto_perfil would require file upload handling like multer
        });
...
// teste
route.get('/teste-prestadores', async (req, res) => {

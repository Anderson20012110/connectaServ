...
import resolverImagem from './utils/resolverImagem.js';
...
// Carrega variável 'usuario' e o helper 'resolverImagem' nos arquivos .ejs
app.use(( req, res, next) => { 
    res.locals.usuario = req.session.usuario || null; 
    res.locals.resolverImagem = resolverImagem;
    next(); 
});
